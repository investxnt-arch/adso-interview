      ...
      <div style={{width:"100%",maxWidth:"400px"}}>
        ...
        <div style={{border:"3px solid #FFE500",background:"#111",padding:"2rem",boxShadow:"8px 8px 0 #FFE500"}}>
          ...
          <div style={{marginTop:"1.5rem",display:"flex",flexDirection:"column",gap:"8px"}}>
            <button onClick={() => signIn("google",{callbackUrl:"/dashboard"})} style={{background:"#000",color:"#fff",border:"2px solid #333",padding:"12px",fontFamily:"monospace",fontSize:"0.8rem",cursor:"pointer"}}>GOOGLE</button>
            <button onClick={() => signIn("github",{callbackUrl:"/dashboard"})} style={{background:"#000",color:"#fff",border:"2px solid #333",padding:"12px",fontFamily:"monospace",fontSize:"0.8rem",cursor:"pointer"}}>GITHUB</button>
          </div>
